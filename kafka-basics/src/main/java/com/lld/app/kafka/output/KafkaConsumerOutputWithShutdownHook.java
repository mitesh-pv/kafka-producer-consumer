...
public class KafkaConsumerOutputWithShutdownHook {
    private static final Logger log = LoggerFactory.getLogger(KafkaConsumerOutputWithShutdownHook.class.getSimpleName());
